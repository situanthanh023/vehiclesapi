...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        if (optionalCar.isEmpty()) {
            throw new CarNotFoundException("No car is available with this id");
        }
        Car car = new Car();
        ...
        try {
            ...
            System.out.println("Error in setting price" + e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Error in setting location" + e.getMessage());
        }
